...
Origine: colonne **"DATA … EFFETTIVA"**. Qui è importante la distinzione di origine (`VisitSource`) già definita in `docs/PROGETTO_PTRP_SYNC.md`.
...
Stimato dal foglio "Nominativi PTRP – Progetto Terapeutico Riabilitativo Personalizzato.xlsx":
...
- `docs/PROGETTO_PTRP_SYNC.md` – modello dati e architettura offline-first
- `docs/DATABASE.md` – schema logico del database SQLite