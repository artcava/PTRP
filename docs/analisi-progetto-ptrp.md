...
- `docs/USER-WORKFLOW.md` (flussi Coordinatore/Educatore)
...
- **ScheduledVisit**: appuntamento programmato
  - tipologia (INTAKE, INTERMEDIATE, FINAL, DISCHARGE, altri eventuali)
...
- **ActualVisit**: visita effettiva
  ...
  - contiene contenuto clinico, presenza paziente, operatori presenti
...
- #71 – completamento modelli dominio per appuntamenti e visite
...
- #71 – Modelli dominio per appuntamenti/visite
...
- Completare modelli dominio (issue #71)
